...
//            System.out.println(c);
    ...
    SSLContext getDTLSContext() throws Exception {
        ...
        String certificateLocation = "./etc/cert.pem";
        String privateKeyLocation = "./etc/key.pem"; //PKCS#8 format

        //---------------------truststore------------------------------//
        //initialise TrustManager factory with truststore
        TrustManagerFactory tmf = TrustManagerFactory.getInstance("SunX509");
        tmf.init(SecureSocketUtil.truststore(certificateLocation));
        //---------------------end-of truststore-----------------------//

        //---------------------keystore--------------------------------//
        //initialise TrustManager factory with keystore
        KeyManagerFactory kmf = KeyManagerFactory.getInstance("SunX509");
        kmf.init(SecureSocketUtil.keystore(certificateLocation, privateKeyLocation, Optional.empty()), "secret".toCharArray());
        //---------------------end-of keystore-------------------------//
...
//keytool -genkeypair -alias client -keyalg RSA -validity 300 -keysize 2048 -keystore keystore
//        keytool -export -alias client -keystore keystore -rfc -file cert.pem
//        keytool -importcert -alias client -file cert.pem -keystore truststore
//
